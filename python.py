...
now = 1715945186 # in sec
expiry = 1816031578 # in sec
nonce = 12345 # unique value
apiKey = "513d5dd4-9c7f-4487-b782-a8274cc9700a"
data = {
  "asset": "BTC",
  "amount": 0.0675,
  "type": "Withdraw",
...
payload = {
 ...
 "sub": apiKey,
 "uri": "/wallet/withdraw",
 "bodyhash": sha256(body.encode('utf-8')).hexdigest()
};
